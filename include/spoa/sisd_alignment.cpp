...
void SisdAlignment::align_sequence_to_graph() {
...
void SisdAlignment::adjust_node_ids(const std::vector<int32_t>& mapping) {
...
inline void SisdAlignment::update_max_score(int32_t* H_row, uint32_t i, uint32_t j) {
...
void SisdAlignment::print_matrix() {
